...
And R will print out the answer, with a preceding "[1]". [1] is the index of the first element of the line being printed in the console. For more information on indexing vectors, see [Subsetting Data (Episode 6)](https://swcarpentry.github.io/r-novice-gapminder/06-data-subsetting/index.html).
